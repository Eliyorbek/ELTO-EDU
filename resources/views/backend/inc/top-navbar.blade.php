<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    <div class="navbar-brand-wrapper d-flex justify-content-center">
      <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
        <a class="navbar-brand brand-logo" style="color: #fff;margin:0 auto; font-size:32px;" href="index.html">ElTo EDU</a>
        <a class="navbar-brand brand-logo-mini" style="color: #fff;margin:0 auto; font-size:32px;" href="index.html">ElTo EDU</a>
        <form action="{{route('hamburger')}}" method="POST">
          @csrf
      ...
      <ul class="navbar-nav me-lg-2">
        <li class="nav-item nav-profile dropdown">
          <a class="nav-link" href="#" data-bs-toggle="dropdown" id="profileDropdown">
            ...
            <span class="nav-profile-name">Tojimatov Eliyorbek</span>
          </a>
      ...
      <ul class="navbar-nav navbar-nav-right">
        <li class="nav-item nav-date dropdown">
          <a class="nav-link d-flex justify-content-center align-items-center" href="javascript:;">
            <h6 class="date mb-0">{{ \Carbon\Carbon::today()->format('d.m.y') }}</h6>
